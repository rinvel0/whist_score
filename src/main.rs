...
fn create_players(num_players: i16) -> Vec<Player> {
...
fn play_round(players: &mut Vec<Player>, num_cards: i16, starting_player_index: usize) {
    // Deal num_cards
...
fn read_validate_bid(num_cards: i16, not_allowed: Option<i16>) -> i16 {
    loop {
...
// Read and validate hands
fn read_validate_hands(players: &mut Vec<Player>, num_cards: i16, starting_player_index: usize) {}
